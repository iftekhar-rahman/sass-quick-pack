$(function () {
  ...
  // var horLength = document.querySelector(".horizontal-section .elementor-container").scrollWidth;
  ...
  //     document.querySelector(".horizontal-section .elementor-container").style.transform = "translateX(-"+(scrollTop - distFromTop)+"px)";
  //   }
